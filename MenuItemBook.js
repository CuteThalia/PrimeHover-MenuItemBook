 ...
 *
 * @param Add to Menu
 * @desc Option for adding the Item Book into the menu (1: true, 0: false).
 * @default 1
 *
 * @param Menu Text
 * @desc The label of the Item Book on the menu (Default: "Item Book").
 * @default Item Book
 *
 * @help
 *
 * In this version, you can also choose whether to show the Item Book on the menu.
 * You can also set a label for the item if you wish to change the label text.
 * (Modified version by PrimeHover)
 *
 * Plugin Command:
 ...
 *
 * @param Menu Text
 * @desc The label of the Item Book in the menu (Default: "Item Book").
 * @default Item Book
 *
 * @help
 *
...
(function() {
    ...
    var addToMenu = Number(parameters['Add to Menu']);
    var menuText = String(parameters['Menu Text'] || 'Item Book');
    ...
    /* Code Added
     * This part of the code was added by PrimeHover
     *
